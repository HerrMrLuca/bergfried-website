...
/* about.html.twig */
class __TwigTemplate_f34a6f22f3f7f6c9b605ed57d3db398f extends Template
{
    private $source;
    private $macros = [];
...
<html>
<head>
  <title>Impressum - Pension Bergfried</title>
...
<div class=\"container\">
  ...
  <nav>
    <div class=\"connav\" id=\"con2\">
      <div class=\"collapse navbar-collapse\" id=\"navbarResponsive\">
        <ul id=\"connav\">
          ...
          <li style=\"float:right\"><a id=\"nav3\" class=\"navl\"><img src=\"https://www.welt-flaggen.de/data/flags/emoji/twitter/256x256/at.png\"></a>
            <ul class=\"language\" id=\"ulnav\">
                <li class=\"language\"><a id=\"EN\" href=\"ENabout\"></a></li>
                <li class=\"language\"><a id=\"CZ\" href=\"CZabout\"></a></li>
            </ul>
          </li>
        ...
        <div>
          <ul id=\"considebar\">
            <li><a id=\"sidebar8\" class=\"sidebar2\" href=\"index\">Startseite</a></li>
            ...
            <li><a id=\"sidebar1\" class=\"sidebar\" href=\"about\">Impressum</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class=\"container\">
    ...
    <br>
     ...
     <p>Die Inhalte dieser Website sind frei nutzbar und dienen ausschließlich der Information.<br>

     Es kommen durch die Nutzung der Auswahlmöglichkeiten der Web-site keinerlei Rechtsgeschäfte zwischen Eigentümer und den Nutzern zu Stande.<br>
     Die weitere Vorgangsweise zwischen Anbietern und Nutzern und der mögliche spätere Abschluss von Aufträgen zwischen Anbietern und Nutzern liegen ausschließlichem Ermessen der Nutzer.</p>
    </div>
    <div class=\"line\">
    </div>
    <div class=\"contentimp2\">
      
        <h2>Copyright / Haftungsausschluss</h2>

 

     <p>Im Hinblick auf die technischen Eigenschaften des Internets kann keine Gewähr für

     Authentizität, Richtigkeit und Vollständigkeit der im Internet zur Verfügung gestellten

     Informationen

     übernommen werden.<br><br> Es wird auch keine Gewähr für die Verfügbarkeit oder den Betrieb

     der gegenständlichen Homepage und ihrer Inhalte übernommen.<br>

 

     Jede Haftung für unmittelbare, mittelbare oder sonstige Schaden, unabhängig von deren

     Ursachen, die aus der Benutzung oder Nichtverfügbarkeit der Daten und Informationen

     dieser Homepage erwachsen, wird, soweit rechtlich zulässig, ausgeschlossen.<br><br>

 

     Der Inhalt dieser Hompage ist urheberrechtlich geschützt.<br> Die Informationen sind für die

     persönliche Verwendung bestimmt.<br> Jede weitergehende Nutzung inbesondere die

     Speicherung in

     Datenbanken, Vervielfältigung und jede Form von gewerblicher Nutzung sowie die

     Weitergabe an

     Dritte- auch in Teilen oder in überarbeiteter Form - ohne Zustimmung des Website

     Inhabers ist untersagt.

     Hyberlinks auf dieser Website sind Willkommen.<br> Jede Einbingung einzelner Seiten unseres

     Angebotes in fremde Frames ist zu unterlassen.

     Trotz sorgfältiger inhaltlicher Kontrolle übernehmen wir keine Haftung für die Inhalte

     externer

     Links.<br> Für den Inhalt der verlinkten Seiten sind ausschließlich deren Betreiber
    ...
    <div class=\"contentimp2\">
     ...
     <p>Soweit auf unseren Seiten personenbezogene Daten (beispielsweise Name, Anschrift oder

     eMail-Adressen) erhoben werden, erfolgt dies soweit möglich, stets ohne Angabe

     personenbezogener Daten.<br><br>

     Der Nutzung von im Rahmen der Impressumspflicht veröffentlichen Kontaktdaten durch

     Dritte zur Übersendung von nicht ausdrücklich angeforderter Werbung und

     Informationsmaterialen wird

     hiermit ausdrücklich widersprochen.<br> <br>Die Betreiber der Seiten behalten sich ausdrücklich

     rechtliche

     Schritte im Falle der unverlangten Zusendung von Werbeinformationen, etwas durch
...
</body></html>", "about.html.twig", "/var/www/html/bergfried/views/about.html.twig");
    }
}
